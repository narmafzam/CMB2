...
class CMB2 extends CMB2_Base
{
	...
	protected $mb_defaults
		= [
			...
			'show_on'          => [], // Post IDs or page templates to display this metabox. overrides 'show_on_cb'.
	...
	{
		return $this->prop('context') && in_array($this->prop('context'), ['form_top', 'before_permalink', 'after_title', 'after_editor'], true);
	}
